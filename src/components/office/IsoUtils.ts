...
export const ROOMS: Record<RoomKey, RoomDef> = {
  ...
  rh:         { x: 0,  y: 3,  w: 4, h: 4, label: "RH",         color: 0x9333EA, emoji: "👥" },
  reuniao:    { x: 4,  y: 3,  w: 4, h: 3, label: "REUNIÃO",    color: 0x64748B, emoji: "🤝" },
  marketing:  { x: 8,  y: 3,  w: 5, h: 4, label: "MARKETING",  color: 0xE64A19, emoji: "📣" },
...
export const ROOM_WAYPOINTS: Record<RoomKey, IsoPoint> = {
  ...
  rh:         { tileX: 2,  tileY: 5  },
  reuniao:    { tileX: 6,  tileY: 4  },
  marketing:  { tileX: 10, tileY: 5  },
